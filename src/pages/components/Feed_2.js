...
const markdownFiles = importAll(require.context('./posts/Etherealities', false, /\.md$/)).sort();
...
class Feed extends Component {
    ...
    render() {
        ...
        return (
            ...
            {
                posts.map((post, idx) => (
                <section className = "posts_2" id = { idx }>
...
window.addEventListener("hashchange", function () {
    window.scrollTo(window.scrollX, window.scrollY - 100.5);
});
