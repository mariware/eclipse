...
function Sun_Top() {
    return (
        <div className = "suntop">
            <Link reloadDocument to="/eclipse/the_sun_2"><h1 className = "title"> THE SUN </h1></Link>
            ...
            <svg viewBox="0 0 1440 400">
                <Link reloadDocument to="/eclipse/the_sun_2"><circle cx="720" cy="300" r="250" fill="#EE1B3E" /></Link>
