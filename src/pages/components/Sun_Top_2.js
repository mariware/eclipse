...
function Sun_Top_2() {
    return (
        <div className = "suntop">
            <Link reloadDocument to="/eclipse/the_sun_3"><h1 className = "title"> THE SUN </h1></Link>
            ...
            <svg viewBox="0 0 1440 400">
                <Link reloadDocument to="/eclipse/the_sun_3"><circle cx="720" cy="300" r="250" fill="#1E76B8" /></Link>
