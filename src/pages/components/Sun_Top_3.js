...
function Sun_Top_2() {
    return (
        <div className = "suntop">
            <Link reloadDocument to="/eclipse/the_sun"><h1 className = "title"> THE SUN </h1></Link>
            ...
            <svg viewBox="0 0 1440 400">
                <Link reloadDocument to="/eclipse/the_sun"><circle cx="720" cy="300" r="250" fill="#7C2E87" /></Link>
